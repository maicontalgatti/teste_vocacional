...
?>
  ...
  <body class="img_back">
    ...
    // global $preferencia_2_tv;
    $_SESSION['preferencia_2_tv'] = $_POST["preferencia_2"]; 
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template bloco_principal align_center">
        ...
        <form method="post" action="pergunta_4.php">
          <table id="tabela_teste" style="width:80%">
            <tr>
            <td> Se tivesse a oportunidade de escolher uma terceira graduação, qual seria a área de estudo que despertaria seu maior interesse e motivação?</td>
            </tr>
            <tr>
            <td>
              <select name='preferencia_3' style='width:100%'>
