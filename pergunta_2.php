...
?>
  ...
  <body class="img_back">
    ...
    // global $preferencia_1_tv;
    $_SESSION['preferencia_1_tv'] = $_POST["preferencia_1"]; 
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template bloco_principal align_center">
        ...
        <form method="post" action="pergunta_3.php">
          <table id="tabela_teste" style="width:80%">
            <tr>
            <td> Se tivesse a oportunidade de escolher uma segunda graduação, qual seria a área de estudo que despertaria seu maior interesse e motivação?</td>
            </tr>
            <tr>
            <td>
              <select name='preferencia_2' style='width:100%'>
