...
?>
  ...
  <body class="img_back">
    ...
    // global $preferencia_4_tv;
    $_SESSION['preferencia_4_tv'] = $_POST["preferencia_4"]; 
      ...
      <div class="starter-template bloco_principal align_center">
        ...
        <form method="post" action="processa_teste.php">
          <table id="tabela_teste" style="width:80%">
            <tr>
            <td> Se tivesse a oportunidade de escolher uma quinta graduação, qual seria a área de estudo que despertaria seu maior interesse e motivação?</td>
            </tr>
            <tr>
            <td>
              <select name='preferencia_5' style='width:100%'>
